...
<div class="d-flex flex-nowrap">
    ...
    <div class="col col-11 ps-3">
        ...
        {{--        Title--}}
        <div>
            <h1 class="text-white mt-4 border-bottom border-white border-4 my-4" style="font-family: 'system-ui'; font-size: xxx-large; text-align: center">QUẢN LÝ LOẠI SÂN</h1>
        </div>
        <div class="">

            {{--            Table--}}
            <table class="table table-light table-striped mt-3" border="1px" cellpadding="0" cellspacing="0" width="100%">
                <thead>
                <tr>
